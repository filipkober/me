...
const AboutMe = () => {
    ...
    return (
        <div className="w-screen h-screen flex items-center flex-col mb-16">
            ...
            <p className="lg:max-w-[25%] text-wrap">
            ...
            <p className="lg:max-w-[25%] text-wrap mb-2">
                Besides programming, I really like:
            </p>
            <ul className="list-disc lg:max-w-[25%] text-wrap mb-4">
                    <li>Cooking</li>
