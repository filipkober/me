...
export default function Page() {
    return (
        <div className="min-h-screen flex flex-col p-4 gap-4 items-center">
            <h1 className="text-5xl gradient-text">Casino</h1>
            ...
            <div className="rounded-xl border-4 border-white grid grid-cols-[1fr_auto_1fr] text-4xl overflow-clip hover:border-blue-300 duration-150">
                <span className="text-center p-4 bg-[linear-gradient(45deg,#166534_25%,#22c55e_25%,#22c55e_50%,#166534_50%,#166534_75%,#22c55e_75%,#22c55e_100%)] bg-[length:20px_20px] text-[1.5rem] md:text-md">DOUBLE</span>
                <span className="px-2 p-4 text-[1.5rem] md:text-md">or</span>
                <span className="text-center p-4 bg-[linear-gradient(45deg,#b91c1c_25%,#f87171_25%,#f87171_50%,#b91c1c_50%,#b91c1c_75%,#f87171_75%,#f87171_100%)] bg-[length:20px_20px] text-[1.5rem] md:text-md">NOTHING</span>
            </div>
            </Link>
            <Link href="/fun/gambling/blackjack" className="w-full">
                <div className="rounded-xl border-4 border-white text-4xl overflow-clip hover:border-blue-300 duration-150 bg-green-800 p-2 relative">
                    <div className="flex justify-center items-center gap-2">
                        ...
                        <span className="ml-auto mr-4 text-yellow-300 font-bold tracking-wider z-10" style={{textShadow: "2px 2px 4px rgba(0,0,0,0.5)"}}>BLACK<br/>JACK</span>
                    </div>
                </div>
            </Link>
            </div>
