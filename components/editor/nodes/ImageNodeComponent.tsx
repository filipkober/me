  ...
  return (
    <Suspense
      fallback={
        ...
        >
          <div
            className="animate-pulse bg-[hsl(var(--background)] rounded-lg"
    ...
    >
      ...
      >
        {isHovered && (
          <div className="absolute top-2 right-2 bg-[hsl(var(--background))] flex justify-center gap-2 p-2 z-10">
            <button
        ...
        <Image
          ...
          alt={alt}
          fill
          sizes={`(min-width: 640px) 640px, (min-width: 768px) 768px, (min-width: 1024px) 1024px, (min-width: 1280px) 1280px, 100vw`}
        />
        {resizing && (
          <div
          ...
          >
            ...
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, ResizeDirection.BottomRight)
              }
            >
              <Plus />
            </div>
            ...
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, ResizeDirection.BottomLeft)
              }
            >
              <Plus />
            </div>
